...
const Message = ({ letter, onOpen }) => {
  ...
  return (
    ...
    >
      ...
      {showTimeCapsule && (
        <motion.div
          ...
          style={{
            textAlign: 'center',
            marginBottom: '1.5rem',
            padding: 'clamp(0.3rem, 1vw, 0.5rem) clamp(1rem, 3vw, 1.5rem)',
        ...
        >
          ...
          <motion.span
            ...
            style={{
              display: 'inline-block',
              marginLeft: 'clamp(0.5rem, 1.5vw, 0.8rem)',
              fontFamily: '"Georgia", serif',
              color: '#F8CC2C',
      ...
      {/* ===== MAIN LETTER ===== */}
      <motion.div
        whileHover={{ scale: isMobile ? 1 : 1.003 }}
        ...
        style={{
          ...
          padding: 'clamp(1.5rem, 4vw, 4rem) clamp(1rem, 3vw, 3.5rem) clamp(1.5rem, 3vw, 3.5rem)',
          boxShadow: `
      ...
      >
        ...
        <div
          style={{
            ...
            right: 0,
            bottom: 0,
            borderRadius: 'clamp(17px, 2.5vw, 25px)',
            background: `
        ...
        <div
          style={{
            ...
            right: -3,
            bottom: -3,
            borderRadius: 'clamp(22px, 3.5vw, 30px)',
            background: `
        ...
        <motion.div
          ...
          animate={inView ? { scale: isMobile ? 0.7 : 1, rotate: 0 } : {}}
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div
            style={{
              ...
              color: '#3d2b1f',
              fontWeight: 300,
              maxHeight: expanded ? 'none' : isMobile ? '250px' : '380px',
              overflow: 'hidden',
              position: 'relative',
              fontFamily: '"Georgia", "Times New Roman", serif',
              padding: '0 0.5rem',
          ...
          >
            <motion.button
              ...
              style={{
                padding: isMobile 
                  ? 'clamp(0.6rem, 2vw, 0.8rem) clamp(1.5rem, 4vw, 3.5rem)' 
                  : '0.8rem 3.5rem',
                background: expanded
                ...
                cursor: 'pointer',
                fontFamily: '"Georgia", "Times New Roman", serif',
                fontSize: isMobile ? 'clamp(0.8rem, 1.8vw, 0.9rem)' : '1rem',
                ...
                maxWidth: isMobile ? 'min(300px, 100%)' : 'none',
              }}
            >
              {!expanded && (
                <span
          ...
          <motion.div
            ...
            style={{
              ...
              color: '#5a3d2b',
              opacity: 0.4,
              fontSize: isMobile ? 'clamp(0.75rem, 1.6vw, 0.85rem)' : '0.95rem',
              fontStyle: 'italic',
              borderTop: '1px solid rgba(139, 107, 77, 0.08)',
              paddingTop: '1.2rem',
            }}
          >
            <div style={{ letterSpacing: isMobile ? '2px' : '4px' }}>
              — 2003 se 2026 tak,
            </div>
            <motion.div
              animate={{
              ...
              style={{
                fontSize: isMobile ? 'clamp(1rem, 3vw, 1.2rem)' : '1.4rem',
                fontWeight: '300',
                marginTop: '0.2rem',
                color: '#4a2c1a',
            ...
            <div style={{ 
              fontSize: isMobile ? 'clamp(0.5rem, 1.2vw, 0.6rem)' : '0.7rem', 
              opacity: 0.4, 
              marginTop: '0.3rem',
